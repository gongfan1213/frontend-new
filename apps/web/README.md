...
Once installed, navigate to the root of the Nexus repo and run `yarn dev:server` (this runs `npx @langchain/langgraph-cli dev --port 54367`).
...
After your LangGraph server is running, execute the following command to start the Nexus app:
